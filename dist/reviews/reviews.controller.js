...
let ReviewsController = class ReviewsController {
    ...
    async getBusinessReviews(businessId, page, perPage) {
        return this.reviewsService.getBusinessReviews(businessId, page || 1, perPage || 20);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Reply to a review (provider)' }),
